...
export const LoginPage: React.FC = () => {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#070a0f] px-4 py-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-950/80 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-8 shadow-2xl relative z-10">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Cinema Management & Operations Command Center
          </p>
        </div>
